...
from model import NeuroFlow, NeuroFlowCross
from utils import postprocess

parser = argparse.ArgumentParser()
parser.add_argument('--shikra_path', default='./model_weights/shikra-7b')
parser.add_argument('--model_path', default='./train_logs/demo_single_subject/sub01_v4/last217.pth')
parser.add_argument('--adapter_path', default='./model_weights/mm_projector.bin')
parser.add_argument('--fmri_encoder', type=str, default='NeuroFlow', help='type of brainnet', choices=['NeuroFlow', 'NeuroFlowCross'])
...
parser.add_argument('--save_path', type=str, default='evaluation/eval_caption/train_v4', help='path to save results')
parser.add_argument('--save_image', type=bool, default=False, help='save image or not')
parser.add_argument('--prompt', default='Describe this image <image> as simply as possible.', help='prompt for the model')
# parser.add_argument('--prompt', default='Provide a comprehensive and detailed description of this image, including its key elements, colors, composition, and any notable features or context that may be relevant. Ensure the description is thorough and captures all significant aspects of the image.', help='prompt for the model')
...
if fmri_encoder == 'NeuroFlowCross':
    voxel2emb = NeuroFlowCross(**kwargs)
elif fmri_encoder == 'NeuroFlow':
